					...
					>
						<div className="flex items-center flex-wrap gap-2 w-3/4 m-auto">
							<div className="flex lower-zip">
								...
								<button
									type="submit"
									className="useZip ml-2 p-2 w-1/3 bg-primary text-white rounded flex flex items-center justify-center gap-1"
								>
								...
								<button
									...
									className="useLocation ml-2 p-2 bg-primary text-white rounded flex flex items-center justify-center gap-1"
								>
