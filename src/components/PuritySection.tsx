  ...
  return (
    <section className="min-h-screen py-20 bg-gray-100 text-center Purity flex items-center justify-center relative">
      <div className="absolute w-full h-[400px]  bottom-[10%] z-10">
        <Image src="/images/curvy-line.svg" alt="Curvy Line" fill className="object-cover" priority />
      </div>
      <div className="container">
        <div className="flex flex-row">
          <div className="left flex-1">
            <div className="PurityBg size-[40rem] w-[25vw] mx-auto flex flex-col items-center justify-center relative overflow-hidden bg-[url('/images/bartender.webp')] bg-cover bg-no-repeat rounded-full bg-center z-20">
