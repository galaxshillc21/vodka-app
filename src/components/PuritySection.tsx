		...
		<section className="min-h-screen py-20 bg-gray-100 text-center Purity flex items-center justify-center relative">
			<div className="absolute w-full h-full bottom-[10%] overflow-x-hidden object-cover pointer-events-none user-select-none top-[40%] z-0">
				<Image
					...
					width={102}
					height={100}
					className="w-[104vw] max-w-[104vw] mx-auto absolute left-[-2]"
					priority
				/>
			</div>
						...
						<div className="text-left bg-white/40 p-6 rounded-lg z-20 drop-shadow-xl backdrop-blur-md">
							...
							<div className="inline-flex items-center justify-center gap-0 mb-6">
								...
								<RotatingText
									...
									colors={["text-orange-400", "text-blue-400", "text-green-400", "text-purple-400"]}
							...
							<p>
								La pureza excepcional de Blat Vodka transforma su experiencia de consumo, ofreciendo
								un Mejor Sabor que se disfruta tanto con hielo como sin él. Gracias a su proceso
								único, garantiza una Mejor Calidad que ayuda a reducir los efectos negativos de la
								resaca, haciendo que cada momento sea más placentero.
								<br />
								<br />
								Además, su suavidad inigualable lo convierte en la Bebida Ideal para cualquier
								ocasión, ya sea en tragos cortos o largos. Blat Vodka también es Mejor para
								Combinar, ya que su pureza realza los sabores de otros ingredientes, permitiéndote
								crear cócteles verdaderamente excepcionales.
							</p>
							{/* <div className="flex flex-row">
