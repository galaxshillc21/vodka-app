			...
			<div className="relative h-[150vh] lgh-[200vh] ">
				...
				<div className="sticky mx-auto top-0 z-20 flex flex-col items-center justify-center h-[60vh] lg:h-screen max-w-4xl w-full text-center">
					<BlurText
						...
						className="font-heading text-4xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mt-6 text-amber-600 mb-6 leading-tight text-center justify-center"
					/>
				</div>
				...
				<div className="relative container mx-auto">
					<div className="w-full text-center mx-auto flex flex-col items-center justify-center">
						<BlurText
							...
							direction="top"
							onAnimationComplete={handleAnimationComplete}
							className="font-heading text-4xl sm:text-4xl md:text-5xl lg:text-5xl font-bold mt-6 text-center text-amber-600 mb-6 leading-tight"
						/>
					</div>
						...
						<div className="w-full h-full backdrop-blur-xl bg-gray-100 z-10 rounded-xl flex flex-row justify-center align-center items-center">
							...
							<div className="content flex-1 text-left">
								<blockquote className="pl-3 border-l-2">
									<h2 className="font-heading font-bold text-amber-600 text-2xl leading-relaxed mb-3 italic">
										{t("span1")}
									</h2>
								</blockquote>
		...
		<section className="BottleDesign h-auto relative py-20 px-4 sm:px-6 lg:px-8">
			<div className="relative container mx-auto h-auto">
				...
				<div className="relative flex flex-row justify-center items-center text-center z-10 w-full lg:mt-20 mt-10">
					...
					<SpotlightCard
						className="custom-spotlight-card overflow-visible!"
