    ...
    <section className="BottleDesign h-auto relative py-20 ">
      <div className="bg ">
        <div className="relative container mx-auto">
          ...
          <div className="relative flex flex-row justify-center items-center text-center relative z-10 w-full h-96">
            <div className="absolute left-20 z-20 pointer-events-none">
              <Image src="/images/blatvodka-bottle-full.webp" alt="Blat Vodka Bottle" className="rotate-[-10deg]" width={250} height={800} priority />
            </div>
            <SpotlightCard className="custom-spotlight-card overflow-visible!" spotlightColor="rgba(0, 229, 255, 0.2)">
              <div className="w-full h-full z-10 rounded-xl flex flex-row justify-center align-center items-center">
