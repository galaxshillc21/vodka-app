		...
		<section className="py-20 px-4 sm:px-6 lg:px-8 h-auto" id="Agua">
			<div className="container mx-auto py-12">
				...
				<div className="lg:flex-row flex-col flex lg:items-stretch gap-8 text-center lg:mt-20 mt-8">
					<div className="flex-1 relative mx-auto h-[500px] lg:h-96 bg-cover bg-center p-4 pt-[80px] lg:pt-4 bg-no-repeat flex justify-start items-end text-center rounded-xl overflow-hidden bg-[url('/images/trigo.jpg')]">
					...
					<div className="flex-1 relative mx-auto h-96 bg-cover bg-center p-4 pt-[80px] lg:pt-4 bg-no-repeat flex justify-start items-end text-center rounded-xl overflow-hidden bg-[url('/images/beach-bg.jpg')]">
