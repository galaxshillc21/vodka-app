  ...
  return (
    <section className="h-auto py-20 bg-gray-100 text-center Purity flex items-center justify-center relative">
      <div className="absolute w-full h-full top-0 overflow-x-hidden object-cover pointer-events-none user-select-none z-0">
        <Image src="/images/curvy-line.svg" alt="Curvy Line" width={102} height={100} className="w-[104vw] max-w-[104vw] mx-auto absolute left-[-2] lg:top-[30%] top-[20%]" priority />
      </div>
      <div className="container relative z-10  px-4 lg:py-0">
        <div className="flex flex-col lg:flex-row lg:gap-12 gap-0 ">
          <div className="left flex-1 max-w-[380px]">
            <div className="PurityBg drop-shadow-xl w-[250px] lg:w-[380px] h-[410px] lg:h-[600px] mx-auto flex flex-col items-center justify-center relative overflow-hidden bg-[url('/images/blat_top.jpg')] bg-cover bg-no-repeat rounded-full bg-center z-20 border border-amber-600">
