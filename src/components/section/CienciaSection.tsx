    ...
    <section className="relative bg-white py-20 h-auto" id="Ciencia">
      <div className="container mx-auto  px-4 h-full">
        <div className="w-full text-center mx-auto flex flex-col items-center justify-center">
          <BlurText text={t("title")} delay={80} animateBy="words" direction="top" onAnimationComplete={handleAnimationComplete} className="font-heading text-4xl sm:text-4xl md:text-5xl lg:text-5xl font-bold mt-6 text-center text-amber-600 mb-6 leading-tight" />
        </div>
        <div className="flex-[0-1-10%] flex flex-row mt-12 align-items-center justify-center gap-12 h-auto">
          ...
          <SpotlightCard className=" shadow-md p-4 flex-1 flex flex-col justify-center items-center rounded-lg custom-spotlight-card overflow-visible!" spotlightColor="rgba(0, 229, 255, 0.2)">
            <Table>
              ...
              <TableBody>
                {marcas.map((marca) => (
                  <TableRow key={marca.marca}>
                    ...
                    <TableCell className={`font-medium ${marca.marca === "Blat Vodka" ? "text-gray-900 font-bold text-lg" : ""}`}>{marca.marca}</TableCell>
