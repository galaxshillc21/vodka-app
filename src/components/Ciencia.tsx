...
export function Ciencia() {
  const t = useTranslations("Ciencia"); // Use the translations for the About section
  const marcas = [
    {
      marca: "Blat Vodka",
      impurezas: "0.0",
  ...
  return (
    <section className="relative bg-white py-20 h-[80vh]" id="Ciencia">
      <div className="container mx-auto  px-4 h-full">
        <h1 className="text-4xl text-center font-bold text-amber-600">La Ciencia Detrás de la Pureza Inigualable</h1>
        <div className="flex flex-[0-1-10%] flex flex-row mt-12 justify-center align-items-center justify-center gap-12 h-auto">
          <div className="flex-1 flex flex-col justify-center items-center pr-12">
            <p className="text-lg mb-4 text-gray-700">
              Los hermanos Banús dedicaron años a investigar y desarrollar un proceso único que elimina las impurezas de la fermentación sin comprometer el sabor. Este método patentado nos permite elaborar Blat Vodka con <span class="font-bold text-amber-600">0.0mg/L de impurezas detectadas</span>,
