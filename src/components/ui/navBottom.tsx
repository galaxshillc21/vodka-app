			...
			<div className="flex justify-around items-center h-14">
				...
				<Link
					...
					className={`flex flex-col items-center ${
						pathname === "/news" ? currentPageClass : "text-gray-600 hover:text-black"
					}`}
				>
					<Newspaper size={20} />
				...
				<Link
					href="/"
					className={`flex flex-col items-center ${
						pathname === "/" ? currentPageClass : "text-gray-600 hover:text-black"
					}`}
				>
					<Home size={20} />
				...
				<Link
					href="/search"
					className={`flex flex-col items-center ${
						pathname === "/search" ? currentPageClass : "text-gray-600 hover:text-black"
					}`}
				>
					<Search size={20} />
